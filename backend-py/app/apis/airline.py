...
class ExtraSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'description', 'airline_id', 'all_flights', 'stackable')
...
class AirlineAircraftSchema(ma.SQLAlchemyAutoSchema):
    class Meta:
        ...
        load_instance = True
        include_fk = True
        fields = ('id', 'aircraft_id', 'airline_id', 'first_class_seats',
                 'business_class_seats', 'economy_class_seats', 'tail_number')


class AirlineSchema(ma.SQLAlchemyAutoSchema):
    nation = ma.Nested('app.apis.location.NationSchema')
    ...
    class Meta:
        ...
        # load_instance = True
        include_fk = True
        fields = ('id', 'name', 'address', 'zip', 'nation_id', 'nation', 'email',
                  'website', 'is_approved', 'first_class_description',
                  'business_class_description', 'economy_class_description', 'extras', 'aircraft')
